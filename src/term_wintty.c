// This file is a stripped-down version of term_tty.c that doesn't do any fancy ioctl stuff
// Its purpose is to create dgdebug_tty.exe, a very stripped-down version of dgdebug that can be used in pipelines on Windows (for things like dgt)
...
void term_get_size(int *width, int *height, int force_w, int force_h) {
	...
	*width = 79;
	*height = 0;
	term_height = force_height ? force_height : 0;
}
