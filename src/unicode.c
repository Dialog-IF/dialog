...
static uint32_t knownpairs[][2] = {
	...
	{0x00dd, 0x00fd}, {0x00de, 0x00fe}, {0x0178, 0x00ff}, {0x0100, 0x0101},
	...
	{0x012a, 0x012b}, {0x012c, 0x012d}, {0x012e, 0x012f}, {0x0132, 0x0133},
	...
	{0x0176, 0x0177}, {0x0179, 0x017a}, {0x017b, 0x017c}, {0x017d, 0x017e},
	{0x0243, 0x0180}, {0x0182, 0x0183}, {0x0184, 0x0185}, {0x0187, 0x0188},
	{0x018b, 0x018c}, {0x0191, 0x0192}, {0x01f6, 0x0195}, {0x0198, 0x0199},
	{0x023d, 0x019a}, {0x0220, 0x019e}, {0x01a0, 0x01a1}, {0x01a2, 0x01a3},
	{0x01a4, 0x01a5}, {0x01a7, 0x01a8}, {0x01ac, 0x01ad}, {0x01af, 0x01b0},
	{0x01b3, 0x01b4}, {0x01b5, 0x01b6}, {0x01b8, 0x01b9}, {0x01bc, 0x01bd},
	{0x01f7, 0x01bf}, {0x01c4, 0x01c6}, {0x01c7, 0x01c9}, {0x01ca, 0x01cc},
	{0x01cd, 0x01ce}, {0x01cf, 0x01d0}, {0x01d1, 0x01d2}, {0x01d3, 0x01d4},
	{0x01d5, 0x01d6}, {0x01d7, 0x01d8}, {0x01d9, 0x01da}, {0x01db, 0x01dc},
	{0x018e, 0x01dd}, {0x01de, 0x01df}, {0x01e0, 0x01e1}, {0x01e2, 0x01e3},
	{0x01e4, 0x01e5}, {0x01e6, 0x01e7}, {0x01e8, 0x01e9}, {0x01ea, 0x01eb},
	{0x01ec, 0x01ed}, {0x01ee, 0x01ef}, {0x01f1, 0x01f3}, {0x01f4, 0x01f5},
	...
	{0x0232, 0x0233}, {0x023b, 0x023c}, {0x0241, 0x0242}, {0x0246, 0x0247},
	{0x0248, 0x0249}, {0x024a, 0x024b}, {0x024c, 0x024d}, {0x024e, 0x024f},
	{0x0370, 0x0371}, {0x0372, 0x0373}, {0x0376, 0x0377}, {0x03fd, 0x037b},
	{0x03fe, 0x037c}, {0x03ff, 0x037d}, {0x0386, 0x03ac}, {0x0388, 0x03ad},
	{0x0389, 0x03ae}, {0x038a, 0x03af}, {0x0391, 0x03b1}, {0x0392, 0x03b2},
	{0x0393, 0x03b3}, {0x0394, 0x03b4}, {0x0395, 0x03b5}, {0x0396, 0x03b6},
	{0x0397, 0x03b7}, {0x0398, 0x03b8}, {0x0399, 0x03b9}, {0x039a, 0x03ba},
	{0x039b, 0x03bb}, {0x039c, 0x03bc}, {0x039d, 0x03bd}, {0x039e, 0x03be},
	{0x039f, 0x03bf}, {0x03a0, 0x03c0}, {0x03a1, 0x03c1}, {0x03a3, 0x03c3},
	{0x03a4, 0x03c4}, {0x03a5, 0x03c5}, {0x03a6, 0x03c6}, {0x03a7, 0x03c7},
	{0x03a8, 0x03c8}, {0x03a9, 0x03c9}, {0x03aa, 0x03ca}, {0x03ab, 0x03cb},
	{0x038c, 0x03cc}, {0x038e, 0x03cd}, {0x038f, 0x03ce}, {0x03cf, 0x03d7},
	{0x03d8, 0x03d9}, {0x03da, 0x03db}, {0x03dc, 0x03dd}, {0x03de, 0x03df},
	{0x03e0, 0x03e1}, {0x03e2, 0x03e3}, {0x03e4, 0x03e5}, {0x03e6, 0x03e7},
	{0x03e8, 0x03e9}, {0x03ea, 0x03eb}, {0x03ec, 0x03ed}, {0x03ee, 0x03ef},
	{0x03f9, 0x03f2}, {0x037f, 0x03f3}, {0x03f7, 0x03f8}, {0x03fa, 0x03fb},
	...
	{0x04c9, 0x04ca}, {0x04cb, 0x04cc}, {0x04cd, 0x04ce}, {0x04c0, 0x04cf},
	...
	{0x1fba, 0x1f70}, {0x1fbb, 0x1f71}, {0x1fc8, 0x1f72}, {0x1fc9, 0x1f73},
	{0x1fca, 0x1f74}, {0x1fcb, 0x1f75}, {0x1fda, 0x1f76}, {0x1fdb, 0x1f77},
	{0x1ff8, 0x1f78}, {0x1ff9, 0x1f79}, {0x1fea, 0x1f7a}, {0x1feb, 0x1f7b},
	{0x1ffa, 0x1f7c}, {0x1ffb, 0x1f7d}, {0x1f88, 0x1f80}, {0x1f89, 0x1f81},
	...
	{0x1fbc, 0x1fb3}, {0x1fcc, 0x1fc3}, {0x1fd8, 0x1fd0}, {0x1fd9, 0x1fd1},
	{0x1fe8, 0x1fe0}, {0x1fe9, 0x1fe1}, {0x1fec, 0x1fe5}, {0x1ffc, 0x1ff3},
};

uint16_t unicode_to_upper(uint16_t ch) {
	int i;

	for(i = 0; i < sizeof(knownpairs)/sizeof(*knownpairs); i++) {
		if(knownpairs[i][1] == ch) return knownpairs[i][0];
	}
...
uint16_t unicode_to_lower(uint16_t ch) {
	...
	for(i = 0; i < sizeof(knownpairs)/sizeof(*knownpairs); i++) {
		if(knownpairs[i][0] == ch) return knownpairs[i][1];
	}
...
int unicode_to_utf8_n(uint8_t *dest, int ndest, const uint16_t *src, int n) {
	int i;
	uint16_t ch;
