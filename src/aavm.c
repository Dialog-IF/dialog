...
static struct aaopinfo aaopinfosrc[] = {
	...
	{AA_MAKE_PAIR_WB,	{AAO_VWORD, AAO_DEST, AAO_DEST}, AAO_VBYTE,		"make_pair"},
	{AA_AUX_PUSH_VAL,	{AAO_VALUE}, 0,						"aux_push_val"},
	{AA_AUX_PUSH_RAW_0,	{AAO_ZERO}, 0,						"aux_push_raw"},
	{AA_AUX_PUSH_RAW,	{AAO_VWORD}, AAO_VBYTE,					"aux_push_raw"},
	{AA_STOP,		{}, 0,							"stop"},
	...
	{AA_IF_RAW_EQ,		{AAO_VWORD, AAO_RAW, AAO_CODE}, AAO_ZERO,		"if_raw_eq"},
	...
	{AA_IF_EQ,		{AAO_VWORD, AAO_VALUE, AAO_CODE}, AAO_VBYTE,		"if_eq"},
	{AA_IF_MEM_EQ_1,	{AAO_VALUE, AAO_INDEX, AAO_RAW, AAO_CODE}, AAO_ZERO,	"if_mem_eq"},
	...
	{AA_IFN_RAW_EQ,		{AAO_VWORD, AAO_RAW, AAO_CODE}, AAO_ZERO,		"ifn_raw_eq"},
	...
	{AA_IFN_EQ,		{AAO_VWORD, AAO_VALUE, AAO_CODE}, AAO_VBYTE,		"ifn_eq"},
	{AA_IFN_MEM_EQ_1,	{AAO_VALUE, AAO_INDEX, AAO_RAW, AAO_CODE}, AAO_ZERO,	"ifn_mem_eq"},
	...
	{AA_ADD_RAW,		{AAO_RAW, AAO_RAW, AAO_DEST}, 0,			"add_raw"},
	{AA_INC_RAW,		{AAO_RAW, AAO_DEST}, 0,				"inc_raw"},
	{AA_SUB_RAW,		{AAO_RAW, AAO_RAW, AAO_DEST}, 0,			"sub_raw"},
	{AA_DEC_RAW,		{AAO_RAW, AAO_DEST}, 0,				"dec_raw"},
	...
	{AA_CHECK_EQ,		{AAO_VWORD, AAO_CODE}, AAO_VBYTE,			"check_eq"},
	{AA_CHECK_GT_EQ,	{AAO_VWORD, AAO_CODE, AAO_CODE}, AAO_VBYTE,		"check_gt_eq"},
	{AA_CHECK_GT,		{AAO_VALUE, AAO_CODE}, AAO_BYTE,			"check_gt"},
	{AA_CHECK_WORDMAP,	{AAO_INDEX, AAO_CODE}, 0,				"check_wordmap"},
	{AA_CHECK_EQ_2A,	{AAO_VWORD, AAO_VWORD, AAO_CODE}, 0,			"check_eq_2"},
