...
On the Z-machine backend, these predicates are most useful within the top status area, where these dimensions are always well-defined. If used anywhere else, they will attempt to provide the width and height of the entire screen.
