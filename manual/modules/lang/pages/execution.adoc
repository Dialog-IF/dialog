...
(The rarely-needed `(nbsp)` creates a “non-breaking space”, which looks identical to a space, but will not allow a line break at that location. It’s mainly used between numbers and units, like “100 km” or “section 5”, and and in various non-English languages, such as before certain punctuation marks in French. If an interpreter cannot provide this, it will produce a normal space.)
