...
reset between tests. (Dialog does not have a mechanism for resetting a
...
different tests to run in total. We'll need 
...
up a separate test with separate input and "blessed" output files, and
if you make a change to part of your game, you'll have to update all
of your different test files to reflect it.
...
you're not), `dgt` can also be used to build your project and run its
unit tests, in addition to Skein testing. See the `dgt` documentation
for details. 
