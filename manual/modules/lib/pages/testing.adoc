...
ship-damage.dg eva.dg mtd.dg shuttle.dg scanner.dg probe.dg hyperspace.dg \
sensor-display.dg sensor.dg arc.dg no-weapons.dg damage.dg d6.dg maneuver.dg \
schema.dg sector.dg bearing.dg grid.dg time.dg utils.dg stdlib.dg < /dev/null
...
Upholding that mandate is the starship Eridanus, on a three-year mission of
discovery.
