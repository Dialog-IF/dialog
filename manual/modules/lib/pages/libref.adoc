...
xref:lang:choicepoints.adoc#at-most-once[(at most once)] (special syntax) +
...
xref:lang:io.adoc#bodystyle[`(body style $)`] +
...
xref:understanding.adoc#liblinks[`(default actions apply to rooms)`] +
...
xref:lang:sugar.adoc#generate[`(generate $ $)`] (special syntax) +
...
xref:lang:beyondprg.adoc#interface[`(interface $)`] (special syntax) +
xref:lang:io.adoc#resources[`(interpreter can embed $)`] +
xref:lang:io.adoc#styletest[`(interpreter supports color)`] +
xref:lang:io.adoc#styletest[`(interpreter supports colour)`] +
...
xref:lang:io.adoc#styletest[`(interpreter supports styling)`] +
xref:lang:builtins.adoc#system[`(interpreter supports undo)`] +
xref:lang:io.adoc#styletest[`(interpreter supports text alignment)`] +
xref:lang:choicepoints.adoc#collect-values[`(into $)`] (special syntax) +
...
xref:lang:io.adoc#bodystyle[`(reset body style)`] +
...
xref:actions.adoc#tickstop[`(stop after this tick)`] +
...
xref:traits.adoc#taggednames[`(tagged name $)`] +
...
xref:lang:builtins.adoc#system[`(transcript active)`] +
...
xref:stdactions.adoc#stdmisc[`(verbosity level $)`] +
