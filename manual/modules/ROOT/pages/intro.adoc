...
Dialog was originally developed by Linus Åkesson and published at {old-home-page}. Since 2025, it has been maintained by the community at {home-page}.
